...
class Canada411Home:
    ...
    def by_phone_no_link(self):
        ...
        if driver.current_url == 'https://canada411.yellowpages.ca/search/reverse.html':
            Canada411Home.is_success = True
            return
        else:
            return

    def testing_by_phone_no_link(self, link):
        My.search_merchant_page(driver, link)
        test.by_phone_no_link()
...
test.testing_by_phone_no_link(My.c411_qa_web_link)
