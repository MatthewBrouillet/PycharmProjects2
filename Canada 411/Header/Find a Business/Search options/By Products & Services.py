...
class Canada411Home:
    ...
    def by_products_services_link(self):
        """
        ...
        if driver.current_url == 'https://canada411.yellowpages.ca/products/':
            Canada411Home.is_success = True
            return
        else:
            return

    def testing_by_products_services_link(self, link):
        My.search_merchant_page(driver, link)
        test.by_products_services_link()
...
test.testing_by_products_services_link(My.c411_qa_web_link)
