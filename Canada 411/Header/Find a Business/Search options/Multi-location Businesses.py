...
class Canada411Home:
    ...
    def by_multi_loc_businesses_link(self):
        """
        ...
        if driver.current_url == 'https://canada411.yellowpages.ca/national/':
            Canada411Home.is_success = True
            return
        else:
            return

    def testing_by_multi_loc_businesses_link(self, link):
        My.search_merchant_page(driver, link)
        test.by_multi_loc_businesses_link()
...
test.testing_by_multi_loc_businesses_link(My.c411_qa_web_link)
