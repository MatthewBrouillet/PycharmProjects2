...
class Canada411Home:
    ...
    def by_city_link(self):
        ...
        if driver.current_url == 'https://canada411.yellowpages.ca/locations/':
            Canada411Home.is_success = True
            return
        else:
            return

    def testing_by_city_link(self, link):
...
test.testing_by_city_link(My.c411_qa_web_link)
