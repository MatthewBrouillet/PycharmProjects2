...
class Canada411Home:
    ...
    def reverse_address_link(self, link):
        """
        ...
        if driver.current_url == link + 'search/address.html':
            Canada411Home.is_success = True
            return
        else:
            return

    def testing_reverse_address_link(self, link):
        My.search_merchant_page(driver, link)
        test.reverse_address_link(link)
...
test.testing_reverse_address_link(My.c411_qa_web_link)
