...
class Canada411Home:
    ...
    def pop_name_directory(self, link):
        """
        ...
        if driver.current_url == link + 'popularnames/':
            Canada411Home.is_success = True
            return
        else:
            return

    def testing_pop_name_directory(self, link):
        My.search_merchant_page(driver, link)
        test.pop_name_directory(link)
...
test.testing_pop_name_directory(My.c411_qa_web_link)
