...
class Canada411Home:
    ...
    def by_area_code_link(self, link):
        """
        ...
        if driver.current_url == link + 'area-code-lookup/':
            Canada411Home.is_success = True
            return
        else:
            return

    def testing_by_area_code_link(self, link):
        My.search_merchant_page(driver, link)
        test.by_area_code_link(link)
...
test.testing_by_area_code_link(My.c411_qa_web_link)
