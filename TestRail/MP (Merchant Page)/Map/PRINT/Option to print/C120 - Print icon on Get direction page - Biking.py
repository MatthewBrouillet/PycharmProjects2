...
class YPPrintOption:
    ...
    def testing_print_option_biking(self, link):
        """
        >> This function executes the steps of the test case
        """
        My.search_merchant_page(driver, link)
        test.print_option_biking()
...
test.testing_print_option_biking(My.yp_web_link + "/merchant/directions/1329952")
