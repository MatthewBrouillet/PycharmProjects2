...
class YPPrintOption:
    ...
    def testing_print_option_driving(self, link):
        """
        >> This function executes the steps of the test case
        """
        My.search_merchant_page(driver, link)
        test.print_option_driving()
...
test.testing_print_option_driving(My.yp_web_link + "/merchant/directions/1329952")
