...
class YPMerchantPageMap:
    ...
    def estimated_travel_time(self):
        ...
        estimated_travel_time_button = My.search_clickable_webelement(
            driver, By.XPATH, '//*[@id="ypgBody"]/div[3]/div/div[4]/div[2]/div[2]/div[4]/button')
        if estimated_travel_time_button:
    ...
    def testing_estimated_travel_time(self, link):
        """
        >> This function executes the steps of the test case
        """
        My.search_merchant_page(driver, link)
        test.estimated_travel_time()
...
test.testing_estimated_travel_time(My.yp_web_link + "/search/si/1/Restaurants/Montreal+QC")
print('----------')
test.testing_estimated_travel_time(My.pj_web_link + "/search/si/1/Restaurants/Montreal+QC")
driver.quit()
sys.exit()
