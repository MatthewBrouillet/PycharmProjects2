...
class YPMerchantCardLinks:
    ...
    def testing_read_more(self, link):
        """
...
test.testing_read_more(My.yp_web_link + "/search/si/1/Restaurants/Montreal+QC")
print('----------')
test.testing_read_more(My.pj_web_link + "/search/si/1/Restaurants/Montreal+QC")
driver.quit()
sys.exit()
