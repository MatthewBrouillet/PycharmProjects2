...
class YPTipsAndIdeas:
    ...
    def tips_ideas_dine_links(self):
        """
        >> This function verifies if the first link of "Dine" in the Tips & Ideas' section is clickable
        """
        ...
        if tips_ideas_container:
            ...
            first_link = My.search_clickable_webelement(
                ...
                "//*[@id='ypgBody']/div[2]/div[4]/div[2]/div[2]/div/div[2]/div[1]/div[2]/div[2]/h4/a")
            if first_link:
                first_link.click()
    ...
    def testing_tips_ideas_dine_links(self, link):
        """
        >> This function will execute the test case, and takes a link as a parameter
        """
        My.search_merchant_page(driver, link)
        test.tips_ideas_dine_links()
...
test.testing_tips_ideas_dine_links(My.yp_web_link)
print('----------')
test.testing_tips_ideas_dine_links(My.pj_web_link)
driver.quit()
sys.exit()
