...
class YPTipsAndIdeas:
    ...
    def tips_ideas_grocery_read_links(self):
        """
    ...
    def testing_tips_ideas_grocery_read_links(self, link):
        """
        >> This function will execute the test case, and takes a link as a parameter
        """
        My.search_merchant_page(driver, link)
        test.tips_ideas_grocery_read_links()
...
test.testing_tips_ideas_grocery_read_links(My.yp_web_link)
print('----------')
test.testing_tips_ideas_grocery_read_links(My.pj_web_link)
driver.quit()
sys.exit()
