...
class YPTipsAndIdeas:
    ...
    def tips_ideas_dine_links_read(self):
        """
    ...
    def testing_tips_ideas_dine_links_read(self, link):
        """
        >> This function will execute the test case, and takes a link as a parameter
        """
        My.search_merchant_page(driver, link)
        test.tips_ideas_dine_links_read()
...
test.testing_tips_ideas_dine_links_read(My.yp_web_link)
print('----------')
test.testing_tips_ideas_dine_links_read(My.pj_web_link)
driver.quit()
sys.exit()
