...
class YPDeleteSearch:
    ...
    def delete_previous_search(self, link):
        ...
        if recent_search_container:
            delete_recent_search = My.search_clickable_webelement(
                recent_search_container, By.XPATH,
                "//*[@id='ypgBody']/div[2]/div[1]/div/div[1]/div[2]/div[2]/ul/li/div[1]/a[2]")
            if delete_recent_search:
                delete_recent_search.click()
                YPDeleteSearch.is_success = True
                return
            else:
                return
        else:
    ...
    def testing_delete_previous_search(self, link):
        ...
        if YPDeleteSearch.is_success:
            print("--> Test case is successful.")
        else:
            print("--> Test case is unsuccessful.")


test = YPDeleteSearch(driver)
